...
function newSlide(attachment) {
  jQuery("#slides").append('<div class="slide" id="'+attachment.id+'"><div class="slide-controls"><span id="controls_'+attachment.id+'">'+attachment.title+'</span><a class="del-slide" href="#" onclick="deleteSlide(\''+attachment.id+'\')" title="Delete slide"><span class="dashicons dashicons-dismiss" style="float:right"></span></a></div><img id="slide_img_'+attachment.id+'" src="'+attachment.url+'"  style="max-width:300px;max-height:185px;"><p><input type="text" size="32" class="slide-title" name="slides_title_'+attachment.id+'" id="slides_title_'+attachment.id+'" value="'+attachment.title+'" placeholder="Title" /><br><textarea cols="32" name="slides_content_'+attachment.id+'" id="slides_content_'+attachment.id+'" placeholder="Caption">'+attachment.caption+'</textarea></p><span class="dashicons dashicons-link" style="float:left;padding:5px;"></span><input type="text" size="28" name="slides_link_'+attachment.id+'" id="slides_link_'+attachment.id+'" value="" placeholder="Link" style="margin:0;" /></div>');
